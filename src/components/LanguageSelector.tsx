  ...
  return (
    <div className="language-selector relative">
      <button
        ...
        className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 focus:outline-none transition-colors"
      >
        ...
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
          {languages.map((language) => (
            <button
              ...
              className={`block px-4 py-2 text-sm text-left w-full transition-colors ${
